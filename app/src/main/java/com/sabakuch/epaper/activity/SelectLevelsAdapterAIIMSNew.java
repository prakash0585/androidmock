...
public class SelectLevelsAdapterAIIMSNew extends RecyclerView.Adapter<SelectLevelsAdapterAIIMSNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterAIIMSNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
