...
public class ResultFragmentNew extends Fragment implements ServiceInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        APIAccess.fetchData(ResultFragmentNew.this, getActivity(), getActivity());
        return rootView;
    }
