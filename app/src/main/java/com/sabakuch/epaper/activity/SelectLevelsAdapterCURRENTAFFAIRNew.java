...
public class SelectLevelsAdapterCURRENTAFFAIRNew extends RecyclerView.Adapter<SelectLevelsAdapterCURRENTAFFAIRNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterCURRENTAFFAIRNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
