...
public class Onlinebanktest extends AppCompatActivity implements View.OnClickListener, ServiceInterface {
    ...
    private OnlineTestPaperAdapterbank adapter;
    //    private OnlineTestPartPaperAdapter mOnlineTestPartPaperAdapter;
    private OnlinePartAdapterBank mOnlinePartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onlinebanktest);
        context = Onlinebanktest.this;
        ...
        try {
            if (context != null && !context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    UrlIndex = 0;
                    APIAccess.fetchPagingData(Onlinebanktest.this, getApplicationContext(), Onlinebanktest.this, true);
                    ...
                    if (!examId.equals("9") && !examId.equals("16")) {
                        if (sectionPosition == 0) {
                            if (sec1ArrayData != null && sec1ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdapterbank(Onlinebanktest.this, arrListData1, sectionPosition);
                            ...
                            if (sec2ArrayData != null && sec2ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdapterbank(Onlinebanktest.this, arrListData2, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
                            ...
                            if (sec3ArrayData != null && sec3ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdapterbank(Onlinebanktest.this, arrListData3, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
                            ...
                            if (sec4ArrayData != null && sec4ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdapterbank(Onlinebanktest.this, arrListData4, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
...
//                        que.setInstruction_data(sectiondetail.get(sectionPosition).getSections().get(selectionPosition).getInstructions().get(0).getInstruction());
    ...
    private void populateSampleData(ArrayList<TestPaperData> arrData) {
        ...
        if (adapter == null) {
            adapter = new OnlineTestPaperAdapterbank(context, arrData, sectionPosition);
            recyclerView.setAdapter(adapter);
        } else {
    ...
    private void populateQuesDataRefresh(ArrayList<QuestionDataResponse.Question> arrData) {
        ...
        if (mOnlinePartAdapter == null) {
            mOnlinePartAdapter = new OnlinePartAdapterBank(context, arrData, this);
