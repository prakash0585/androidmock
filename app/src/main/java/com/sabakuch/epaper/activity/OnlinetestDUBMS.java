...
public class OnlinetestDUBMS extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestDUBMS.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestDUBMS.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestDUBMS.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestDUBMS.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestDUBMS.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestDUBMS.this, Constants.Permission, SabakuchEmockApplication.permission);
