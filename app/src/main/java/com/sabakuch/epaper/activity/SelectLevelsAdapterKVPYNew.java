...
public class SelectLevelsAdapterKVPYNew extends RecyclerView.Adapter<SelectLevelsAdapterKVPYNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterKVPYNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
