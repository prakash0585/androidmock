...
public class SelectLevelsAdapterNew extends RecyclerView.Adapter<SelectLevelsAdapterNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
