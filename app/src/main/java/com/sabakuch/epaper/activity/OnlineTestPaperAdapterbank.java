...
public class OnlineTestPaperAdapterbank extends RecyclerView.Adapter<OnlineTestPaperAdapterbank.MyViewHolder> {
    ...
    public OnlineTestPaperAdapterbank(Activity context, List<TestPaperData> data, int sectionPosition) {
        ...
        public void setData(final TestPaperData current, final int position) {
            ...
            llTestOption1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinebanktest.selectedAnswers1.set(position, "a");
                        Onlinebanktest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinebanktest.selectedAnswers2.set(position, "a");
                        Onlinebanktest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinebanktest.selectedAnswers3.set(position, "a");
                        Onlinebanktest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinebanktest.selectedAnswers4.set(position, "a");
                        Onlinebanktest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption1.setChecked(true);
                    rgTestOption2.setChecked(false);
                    rgTestOption3.setChecked(false);
            ...
            llTestOption2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinebanktest.selectedAnswers1.set(position, "b");
                        Onlinebanktest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinebanktest.selectedAnswers2.set(position, "b");
                        Onlinebanktest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinebanktest.selectedAnswers3.set(position, "b");
                        Onlinebanktest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinebanktest.selectedAnswers4.set(position, "b");
                        Onlinebanktest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption2.setChecked(true);
                    rgTestOption1.setChecked(false);
            ...
            llTestOption3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinebanktest.selectedAnswers1.set(position, "c");
                        Onlinebanktest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinebanktest.selectedAnswers2.set(position, "c");
                        Onlinebanktest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinebanktest.selectedAnswers3.set(position, "c");
                        Onlinebanktest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinebanktest.selectedAnswers4.set(position, "c");
                        Onlinebanktest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption3.setChecked(true);
                    rgTestOption2.setChecked(false);
            ...
            llTestOption4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinebanktest.selectedAnswers1.set(position, "d");
                        Onlinebanktest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinebanktest.selectedAnswers2.set(position, "d");
                        Onlinebanktest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinebanktest.selectedAnswers3.set(position, "d");
                        Onlinebanktest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinebanktest.selectedAnswers4.set(position, "d");
                        Onlinebanktest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption4.setChecked(true);
                    rgTestOption2.setChecked(false);
