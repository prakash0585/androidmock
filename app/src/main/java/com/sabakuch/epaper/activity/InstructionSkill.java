...
public class InstructionSkill extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="25",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionSkill.this;

        footerSelColor = ContextCompat.getColor(InstructionSkill.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionSkill.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionSkill.this, getApplicationContext(), InstructionSkill.this,true);
                }	else {
        ...
        tvStartTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    ...
                    bundle.putString(Constants.EXAM_ID, "25");
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=25&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionSkill.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionSkill.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionSkill.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionSkill.this, Constants.Permission, SabakuchEmockApplication.permission);
