...
public class SelectLevelsAdapterSSCNew extends RecyclerView.Adapter<SelectLevelsAdapterSSCNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterSSCNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
