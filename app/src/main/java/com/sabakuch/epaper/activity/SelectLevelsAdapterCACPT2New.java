...
public class SelectLevelsAdapterCACPT2New extends RecyclerView.Adapter<SelectLevelsAdapterCACPT2New.MyViewHolder> {
    ...
    public SelectLevelsAdapterCACPT2New(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
