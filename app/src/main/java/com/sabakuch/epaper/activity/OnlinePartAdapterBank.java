...
public class OnlinePartAdapterBank extends BaseAdapter {
    Context cxt;
    OnClickListener mOnClickListener;
    StringBuilder stringBuilder;
    private ArrayList<QuestionDataResponse.Question> data;

    public OnlinePartAdapterBank(Context cxt, ArrayList<QuestionDataResponse.Question> question,
                             OnClickListener mOnClickListener) {
        this.cxt = cxt;
        this.data = question;
                ...
                mPlanetHolder.llTestOption1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (que.getSectionposition() == 0) {
                            ...
                            Onlinecacpttest.selectedQuestionId1.set(position, que.getQbId());
                        } else if (que.getSectionposition() == 1) {
                            Onlinecacpttest.selectedAnswers2.set(position, "a");
                            Onlinecacpttest.selectedQuestionId2.set(position, que.getQbId());
                        } else if (que.getSectionposition() == 2) {
                            Onlinecacpttest.selectedAnswers3.set(position, "a");
                            Onlinecacpttest.selectedQuestionId3.set(position, que.getQbId());
                        }
