...
public class OnlinetestJeeAdv extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestJeeAdv.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestJeeAdv.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestJeeAdv.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestJeeAdv.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestJeeAdv.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestJeeAdv.this, Constants.Permission, SabakuchEmockApplication.permission);
