...
public class OnlinetestKvpy extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestKvpy.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestKvpy.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestKvpy.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestKvpy.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestKvpy.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestKvpy.this, Constants.Permission, SabakuchEmockApplication.permission);
