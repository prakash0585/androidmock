...
public class SelectLevelsAdapterNEETNew extends RecyclerView.Adapter<SelectLevelsAdapterNEETNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterNEETNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
