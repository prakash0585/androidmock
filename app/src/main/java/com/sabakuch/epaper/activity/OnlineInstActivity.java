...
public class OnlineInstActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static String TAG = OnlineInstActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_online_inst);
        setupToolbar();
        setIdd();

        footerSelColor = ContextCompat.getColor(OnlineInstActivity.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlineInstActivity.this, R.color.white);
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            case R.id.ll_home:
                ...
                {
                    setHomeColor();
                    //  startActivity(new Intent(OnlineInstActivity.this,OnlineInstActivity.class));
                    setFragment(new SelectExamsFragment());
                }
                break;
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlineInstActivity.this, Constants.IS_LOGIN);
                if (isLogin)
                ...
                {
                    CommonUtils.loginAlertDialog(OnlineInstActivity.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlineInstActivity.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlineInstActivity.this, Constants.Permission, SabakuchEmockApplication.permission);
