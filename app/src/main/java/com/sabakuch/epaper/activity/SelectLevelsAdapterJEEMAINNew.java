...
public class SelectLevelsAdapterJEEMAINNew extends RecyclerView.Adapter<SelectLevelsAdapterJEEMAINNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterJEEMAINNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
