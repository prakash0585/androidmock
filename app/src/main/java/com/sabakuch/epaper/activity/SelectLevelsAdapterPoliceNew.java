...
public class SelectLevelsAdapterPoliceNew extends RecyclerView.Adapter<SelectLevelsAdapterPoliceNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterPoliceNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
