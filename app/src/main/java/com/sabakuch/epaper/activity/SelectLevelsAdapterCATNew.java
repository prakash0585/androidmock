...
public class SelectLevelsAdapterCATNew extends RecyclerView.Adapter<SelectLevelsAdapterCATNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterCATNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
