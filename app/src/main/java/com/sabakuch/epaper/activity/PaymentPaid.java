...
public class PaymentPaid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelid= getIntent().getStringExtra(Constants.LEVEL_ID);
        setupToolbar();

        String url= "https://sabakuch.com/elearning/mock/"+slug+"/customtest?level_id="+levelid;
...
/*
    ...
    protected void showAppExitDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(PaymentPaid.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                // PaymentPaid.super.onBackPressed();
                startActivity(new Intent(PaymentPaid.this,MainActivity.class));
            }
        });
