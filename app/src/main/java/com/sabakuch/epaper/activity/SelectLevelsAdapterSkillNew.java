...
public class SelectLevelsAdapterSkillNew extends RecyclerView.Adapter<SelectLevelsAdapterSkillNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterSkillNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
