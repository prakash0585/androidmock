...
public class InstructionKVPY extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="16",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionKVPY.this;

        footerSelColor = ContextCompat.getColor(InstructionKVPY.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionKVPY.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionKVPY.this, getApplicationContext(), InstructionKVPY.this,true);
                }	else {
        ...
        tvStartTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    ...
                    bundle.putString(Constants.EXAM_ID, "16");
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=16&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionKVPY.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionKVPY.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionKVPY.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionKVPY.this, Constants.Permission, SabakuchEmockApplication.permission);
