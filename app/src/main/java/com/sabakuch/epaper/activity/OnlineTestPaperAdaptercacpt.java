...
public class OnlineTestPaperAdaptercacpt extends RecyclerView.Adapter<OnlineTestPaperAdaptercacpt.MyViewHolder> {
    ...
    public OnlineTestPaperAdaptercacpt(Activity context, List<TestPaperData> data, int sectionPosition) {
        ...
        public void setData(final TestPaperData current, final int position) {
            ...
            llTestOption1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinecacpttest.selectedAnswers1.set(position, "a");
                        Onlinecacpttest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinecacpttest.selectedAnswers2.set(position, "a");
                        Onlinecacpttest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinecacpttest.selectedAnswers3.set(position, "a");
                        Onlinecacpttest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinecacpttest.selectedAnswers4.set(position, "a");
                        Onlinecacpttest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption1.setChecked(true);
                    rgTestOption2.setChecked(false);
                    rgTestOption3.setChecked(false);
            ...
            llTestOption2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinecacpttest.selectedAnswers1.set(position, "b");
                        Onlinecacpttest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinecacpttest.selectedAnswers2.set(position, "b");
                        Onlinecacpttest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinecacpttest.selectedAnswers3.set(position, "b");
                        Onlinecacpttest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinecacpttest.selectedAnswers4.set(position, "b");
                        Onlinecacpttest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption2.setChecked(true);
                    rgTestOption1.setChecked(false);
            ...
            llTestOption3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinecacpttest.selectedAnswers1.set(position, "c");
                        Onlinecacpttest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinecacpttest.selectedAnswers2.set(position, "c");
                        Onlinecacpttest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinecacpttest.selectedAnswers3.set(position, "c");
                        Onlinecacpttest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinecacpttest.selectedAnswers4.set(position, "c");
                        Onlinecacpttest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption3.setChecked(true);
                    rgTestOption2.setChecked(false);
            ...
            llTestOption4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        Onlinecacpttest.selectedAnswers1.set(position, "d");
                        Onlinecacpttest.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        Onlinecacpttest.selectedAnswers2.set(position, "d");
                        Onlinecacpttest.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        Onlinecacpttest.selectedAnswers3.set(position, "d");
                        Onlinecacpttest.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        Onlinecacpttest.selectedAnswers4.set(position, "d");
                        Onlinecacpttest.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption4.setChecked(true);
                    rgTestOption2.setChecked(false);
