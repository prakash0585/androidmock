...
public class SelectLevelsAdapterCLATNew extends RecyclerView.Adapter<SelectLevelsAdapterCLATNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterCLATNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
