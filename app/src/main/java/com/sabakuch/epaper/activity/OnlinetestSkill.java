...
public class OnlinetestSkill extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestSkill.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestSkill.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestSkill.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestSkill.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestSkill.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestSkill.this, Constants.Permission, SabakuchEmockApplication.permission);
