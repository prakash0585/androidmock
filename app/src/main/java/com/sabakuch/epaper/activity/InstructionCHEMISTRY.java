...
public class InstructionCHEMISTRY extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="22",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionCHEMISTRY.this;

        footerSelColor = ContextCompat.getColor(InstructionCHEMISTRY.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionCHEMISTRY.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionCHEMISTRY.this, getApplicationContext(), InstructionCHEMISTRY.this,true);
                }	else {
        ...
        tvStartTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    ...
                    bundle.putString(Constants.EXAM_ID, "22");
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=22&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionCHEMISTRY.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionCHEMISTRY.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionCHEMISTRY.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionCHEMISTRY.this, Constants.Permission, SabakuchEmockApplication.permission);
