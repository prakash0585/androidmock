...
public class InstructionGK extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="8",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionGK.this;

        footerSelColor = ContextCompat.getColor(InstructionGK.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionGK.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionGK.this, getApplicationContext(), InstructionGK.this,true);
                }	else {
        ...
        tvStartTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    ...
                    bundle.putString(Constants.EXAM_ID, "8");
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=8&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionGK.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionGK.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionGK.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionGK.this, Constants.Permission, SabakuchEmockApplication.permission);
