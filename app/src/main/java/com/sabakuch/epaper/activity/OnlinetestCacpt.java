...
public class OnlinetestCacpt extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestCacpt.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestCacpt.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestCacpt.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestCacpt.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestCacpt.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestCacpt.this, Constants.Permission, SabakuchEmockApplication.permission);
