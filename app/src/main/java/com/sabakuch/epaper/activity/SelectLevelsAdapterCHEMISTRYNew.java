...
public class SelectLevelsAdapterCHEMISTRYNew extends RecyclerView.Adapter<SelectLevelsAdapterCHEMISTRYNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterCHEMISTRYNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
