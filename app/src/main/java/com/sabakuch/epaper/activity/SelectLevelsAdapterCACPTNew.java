...
public class SelectLevelsAdapterCACPTNew extends RecyclerView.Adapter<SelectLevelsAdapterCACPTNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterCACPTNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
