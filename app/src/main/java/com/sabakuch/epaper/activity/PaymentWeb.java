...
public class PaymentWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url= "https://sabakuch.com/elearning/mock/payment/pid/5/subpid/11/examid/"+sessionId;
...
/*
    ...
    protected void showAppExitDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(PaymentWeb.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
               // PaymentWeb.super.onBackPressed();
                startActivity(new Intent(PaymentWeb.this,MainActivity.class));
            }
        });
