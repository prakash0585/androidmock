...
public class SelectLevelsAdapterNTSENew extends RecyclerView.Adapter<SelectLevelsAdapterNTSENew.MyViewHolder> {
    ...
    public SelectLevelsAdapterNTSENew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
