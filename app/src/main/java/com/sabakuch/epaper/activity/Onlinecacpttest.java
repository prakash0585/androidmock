...
public class Onlinecacpttest extends AppCompatActivity implements View.OnClickListener, ServiceInterface {
    ...
    private OnlineTestPaperAdaptercacpt adapter;
    ...
    private TextView  tvExamName, tvSubject, tvLevel;
    ...
    private String type;
    private String examId = "2", levelId = "1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onlinecacpttest);
        context = Onlinecacpttest.this;
        strUserID = CommonUtils.getStringPreferences(getApplicationContext(), Constants.USER_ID);
        strUserName = CommonUtils.getStringPreferences(getApplicationContext(), Constants.USER_NAME);
        ...
        try {
            if (context != null && !context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    UrlIndex = 0;
                    APIAccess.fetchPagingData(Onlinecacpttest.this, getApplicationContext(), Onlinecacpttest.this, true);
    ...
    private void setId() {
        ...
        lstPart = (ListView) findViewById(R.id.lstPart);
        tvTimerValue = (TextView) findViewById(R.id.tv_timer);
        ...
        spSection = (Spinner) findViewById(R.id.sp_section1);
        tvTotalMarks = (TextView) findViewById(R.id.tv_total_marks);
                    ...
                    if (!examId.equals("9") && !examId.equals("16")) {
                        if (sectionPosition == 0) {
                            if (sec1ArrayData != null && sec1ArrayData.size() > 0) {
                                ...
                                Toast.makeText(Onlinecacpttest.this, "dksdksndks", Toast.LENGTH_SHORT).show();
                                adapter = new OnlineTestPaperAdaptercacpt(Onlinecacpttest.this, arrListData1, sectionPosition);
                            ...
                            if (sec2ArrayData != null && sec2ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdaptercacpt(Onlinecacpttest.this, arrListData2, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
                            ...
                            if (sec3ArrayData != null && sec3ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdaptercacpt(Onlinecacpttest.this, arrListData3, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
                            ...
                            if (sec4ArrayData != null && sec4ArrayData.size() > 0) {
                                ...
                                adapter = new OnlineTestPaperAdaptercacpt(Onlinecacpttest.this, arrListData4, sectionPosition);
                                recyclerView.setAdapter(adapter);
                            } else {
                                adapter = null;
                                UrlIndex = 3;
...
//                                mPageMessageDetailAdapter.notifyDataSetChanged();
   ...
   /* protected void setFragment(Fragment fragment) {
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/paperdetail?exam_id=21&level_id=1");
                //  response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_DETAIL + "?exam_id=21" + "&level_id=1");
            } else if (UrlIndex == 1) {
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_SECTION_DETAIL + "?exam_id=21" +  "&level_id=1"  + "&section=1");
            } else if (UrlIndex == 2) {
                if (sectionPosition == 0) {
                    pageSection1++;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?page=" + pageSection1 + "&exam_id=21" + "&level_id=1" + "&section_id=" + strSectionId);
                } else if (sectionPosition == 1) {
                    pageSection2++;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?page=" + pageSection2 + "&exam_id=21"  + "&level_id=1" + "&section_id=" + strSectionId);
                } else if (sectionPosition == 2) {
                    pageSection3++;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?page=" + pageSection3 + "&exam_id=21" + "&level_id=1"  + "&section_id=" + strSectionId);
                } else if (sectionPosition == 3) {
                    pageSection4++;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?page=" + pageSection4 + "&exam_id=21" + "&level_id=1"  + "&section_id=" + strSectionId);
                }
                loading = true;
            } else if (UrlIndex == 3) {
                if (sectionPosition == 0) {
                    pageSection1 = 1;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?feed=1&exam_id=21" + "&level_id=1" + "&section_id=" + strSectionId );
                } else if (sectionPosition == 1) {
                    pageSection2 = 1;
                    response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?feed=1&exam_id=21"  + "&level_id=1"  + "&section_id=" + strSectionId);
                } else if (sectionPosition == 2) {
                ...
                pageSection1 = 1;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?" + "&exam_id=21" + "&level_id=1" + "&partid=" + strSectionId + "&sec_ids1=" + sectiondetail.get(sectionPosition).getSections().get(selectionPosition).getSectionid());
            } else if (UrlIndex == 8) {
                // to call only NVPY papers from section wise
                // if exam id == 8 (NVPY)
                pageSection1 = 1;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_QUESTIONS + "?" + "&feed=1&exam_id=21" + "&level_id=1"  + "&section_id=" + sectiondetail.get(sectionPosition).getSections().get(selectionPosition).getSectionid());
            } else if (UrlIndex == 9) {
...
//                pageSection1++;
            ...
            if (UrlIndex == 5) {
                ...
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_SECTION_DETAIL + "?exam_id=21"  + "&level_id=1" +
                        "&part=1");
            } else if (UrlIndex == 11) {
                // to call only to get passage array i.e fixed
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_PASSAGE + "?exam_id=21" + "&level_id=1" +
                        "&is_fix=1");
            } else if (UrlIndex == 12) {
            ...
            if (SabaKuchParse.getResponseCode(str) != null && SabaKuchParse.getResponseCode(str).equalsIgnoreCase("200")) {
                if (UrlIndex == 0) { // UrlIndex == 0
                    ...
                    if (arrSectionData != null && arrSectionData.size() > 0) {
                        ...
                        sectionAdapter = new ProfileSettingsAdapter(getApplicationContext(), alSectionName);
                    ...
                    if (SabaKuchParse.jsonTestPaperResult(str) != null && SabaKuchParse.jsonTestPaperResult(str).length() > 0) {
                       ...
                       /* Fragment fragment = new ResultFragmentNew();
                        ...
                        Intent i=new Intent(context,ResultBank.class);
                        Bundle bundle = new Bundle();
                        bundle.putString(Constants.LAST_PAPER_ID, SabaKuchParse.jsonTestPaperResult(str));
                        i.putExtras(bundle);
...
//                        que.setInstruction_data(sectiondetail.get(sectionPosition).getSections().get(selectionPosition).getInstructions().get(0).getInstruction());
    ...
    private void populateSampleData(ArrayList<TestPaperData> arrData) {
        ...
        if (adapter == null) {
            adapter = new OnlineTestPaperAdaptercacpt(context, arrData, sectionPosition);
            recyclerView.setAdapter(adapter);
        } else {
