...
public class SelectLevelsAdapterDUBMSNew extends RecyclerView.Adapter<SelectLevelsAdapterDUBMSNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterDUBMSNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
