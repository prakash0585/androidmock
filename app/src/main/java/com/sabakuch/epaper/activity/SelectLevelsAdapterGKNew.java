...
public class SelectLevelsAdapterGKNew extends RecyclerView.Adapter<SelectLevelsAdapterGKNew.MyViewHolder> {
    ...
    public SelectLevelsAdapterGKNew(Context context, List<LevelsData> data, String examId, String level1Status, String level2Status, String level3Status) {
