...
public class AIIMS extends AppCompatActivity implements ServiceInterface{
    private RecyclerView recyclerView;
    private SelectLevelsAdapterAIIMSNew adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(AIIMS.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(AIIMS.this, R.color.white);
        ...
        try {
            if (context != null && !context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    UrlIndex = 0;
                    APIAccess.fetchPagingData(AIIMS.this, getApplicationContext(), AIIMS.this, true);
                } else {
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_USER_DETAIL + "?exam_id=27" + "&user_id=" + strUserID);
            }
            if (UrlIndex == 1) {
                page++;
            ...
            if (SabaKuchParse.getResponseCode(str) != null && SabaKuchParse.getResponseCode(str).equalsIgnoreCase("200")) {
                if (UrlIndex == 0) {
                    ...
                    if (arrData.size() > 0)
                    {
                        ...
                        adapter = new SelectLevelsAdapterAIIMSNew(context, arrListData, examId, level1Status, level2Status, level3Status);
   ...
   /* private void setIdd() {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(AIIMS.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(AIIMS.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AIIMS.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(AIIMS.this, Constants.Permission, SabakuchEmockApplication.permission);
