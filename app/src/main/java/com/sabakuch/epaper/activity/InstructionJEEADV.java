...
public class InstructionJEEADV extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="9",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionJEEADV.this;

        footerSelColor = ContextCompat.getColor(InstructionJEEADV.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionJEEADV.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionJEEADV.this, getApplicationContext(), InstructionJEEADV.this,true);
                }	else {
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=9&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionJEEADV.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionJEEADV.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionJEEADV.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionJEEADV.this, Constants.Permission, SabakuchEmockApplication.permission);
