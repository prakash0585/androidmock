...
public class InstructionAIIMS extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    private String examId="27",levelId="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionAIIMS.this;

        footerSelColor = ContextCompat.getColor(InstructionAIIMS.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionAIIMS.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionAIIMS.this, getApplicationContext(), InstructionAIIMS.this,true);
                }	else {
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=27&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionAIIMS.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionAIIMS.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionAIIMS.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionAIIMS.this, Constants.Permission, SabakuchEmockApplication.permission);
