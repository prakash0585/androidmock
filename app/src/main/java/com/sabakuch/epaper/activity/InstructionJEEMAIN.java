...
public class InstructionJEEMAIN extends AppCompatActivity implements ServiceInterface,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=InstructionJEEMAIN.this;

        footerSelColor = ContextCompat.getColor(InstructionJEEMAIN.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(InstructionJEEMAIN.this, R.color.white);
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionJEEMAIN.this, getApplicationContext(), InstructionJEEMAIN.this,true);
                }	else {
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                response = OpenConnection.callUrl("https://sabakuch.com/mock_paper/api/instructions?exam_id=2&level_id=1");
            }else if(UrlIndex == 1){
                postUserDetail();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(InstructionJEEMAIN.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(InstructionJEEMAIN.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(InstructionJEEMAIN.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(InstructionJEEMAIN.this, Constants.Permission, SabakuchEmockApplication.permission);
