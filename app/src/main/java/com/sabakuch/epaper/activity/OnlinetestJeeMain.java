...
public class OnlinetestJeeMain extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        footerSelColor = ContextCompat.getColor(OnlinetestJeeMain.this, R.color.blue_theme);
        footerUnSelColor = ContextCompat.getColor(OnlinetestJeeMain.this, R.color.white);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_statistics:
                boolean isLogin = CommonUtils.getLoginPreferences(OnlinetestJeeMain.this, Constants.IS_LOGIN);
                if (isLogin) {
                    if (isNavigatingStatus()) {
                    ...
                    CommonUtils.loginAlertDialog(OnlinetestJeeMain.this, getResources().getString(R.string.please_login_to_access_this_feature));
                }
                break;
    ...
    public void quitExamAlertDialog(final int tabPosition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinetestJeeMain.this);
...
//            } else {
            ...
            CommonUtils.saveIntPreferences(OnlinetestJeeMain.this, Constants.Permission, SabakuchEmockApplication.permission);
