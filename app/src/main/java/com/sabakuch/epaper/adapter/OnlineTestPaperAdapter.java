...
public class OnlineTestPaperAdapter extends RecyclerView.Adapter<OnlineTestPaperAdapter.MyViewHolder> {
    ...
    public OnlineTestPaperAdapter(Activity context, List<TestPaperData> data, int sectionPosition) {
            ...
            llTestOption1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        ...
                        OnlineTestPaperSectionFragment.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        OnlineTestPaperSectionFragment.selectedAnswers2.set(position, "a");
                        OnlineTestPaperSectionFragment.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        OnlineTestPaperSectionFragment.selectedAnswers3.set(position, "a");
                        OnlineTestPaperSectionFragment.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        OnlineTestPaperSectionFragment.selectedAnswers4.set(position, "a");
                        OnlineTestPaperSectionFragment.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption1.setChecked(true);
                    rgTestOption2.setChecked(false);
                    rgTestOption3.setChecked(false);
            ...
            llTestOption2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        ...
                        OnlineTestPaperSectionFragment.selectedAnswers4.set(position, "b");
                        OnlineTestPaperSectionFragment.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption2.setChecked(true);
                    rgTestOption1.setChecked(false);
            ...
            llTestOption3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        ...
                        OnlineTestPaperSectionFragment.selectedAnswers4.set(position, "c");
                        OnlineTestPaperSectionFragment.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption3.setChecked(true);
                    rgTestOption2.setChecked(false);
            ...
            llTestOption4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        ...
                        OnlineTestPaperSectionFragment.selectedAnswers4.set(position, "d");
                        OnlineTestPaperSectionFragment.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption4.setChecked(true);
                    rgTestOption2.setChecked(false);
