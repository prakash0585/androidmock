...
import com.sabakuch.epaper.activity.PaymentPaid;
...
public class Instructionpaid extends Fragment implements ServiceInterface {
    private View rootView;
    private TextView tvTitle,tvStartTest;
    private WebView tvInstructions;
    private Activity context;
    private ArrayList<InstructionsData> arrData, arrListData = new ArrayList<>();
    private String examId="",levelId="",slug="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_instructioncustom, container, false);
        CommonUtils.setTracking(Instructionpaid.class.getSimpleName());
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(Instructionpaid.this, getActivity(), getActivity(),true);
                }	else {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                   /* Fragment fragment = new OnlineTestPaperSectionFragment();
                    ...
                    Intent intentp=new Intent(context, PaymentPaid.class);
                    intentp.putExtra(Constants.EXAM_ID, examId);
                    intentp.putExtra(Constants.SLUG, slug);
                    intentp.putExtra(Constants.LEVEL_ID, levelId);
            ...
            if (SabaKuchParse.getResponseCode(str) != null && SabaKuchParse.getResponseCode(str).equalsIgnoreCase("200")) {
                if (UrlIndex == 0) {
                    ...
                    if (arrData.size() > 0) {
                        ...
                        tvInstructions.loadDataWithBaseURL(null, arrData.get(0).instruction.trim(), "text/html", "utf-8", null);
