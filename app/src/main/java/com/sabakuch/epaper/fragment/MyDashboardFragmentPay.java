...
public class MyDashboardFragmentPay extends Fragment implements ServiceInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_my_dashboard_fragment_pay, container, false);
        ...
        setupToolbar();
        //  APIAccess.fetchData(MyDashboardFragmentPay.this, getActivity(), getActivity());
        return rootView;
    }
...
//                            if (totalPage > page) {
//                                UrlIndex = 0;
//                                APIAccess.fetchPagingData(MyDashboardFragmentPay.this, getActivity(), getActivity(), true);
//                            } else {
//                            }
//                        }
//                    }
...
//            }
    ...
    public String httpPost()
    {
        ...
        try {
            if (UrlIndex == 0) {
                page++;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" + "&user_id=" + strUserID+"&premium_exam=1");
            } else if (UrlIndex == 1) {
                page = 1;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" + "&user_id=" + strUserID+"&premium_exam=1");
            }
...

    {
...

        {
...

            {
                ...
                arrData = SabaKuchParse.parseDashboardDataa(str);
                if (UrlIndex == 0)
