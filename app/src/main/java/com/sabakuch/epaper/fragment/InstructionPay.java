...
public class InstructionPay extends Fragment implements ServiceInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CommonUtils.setTracking(InstructionPay.class.getSimpleName());
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(InstructionPay.this, getActivity(), getActivity(),true);
                }	else {
    ...
    private void setId() {
        ...
        tvStartTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    Fragment fragment = new OnlineTestPaperSectionFragmentPay();
