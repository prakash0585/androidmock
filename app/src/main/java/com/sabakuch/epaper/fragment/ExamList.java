...
import com.sabakuch.epaper.adapter.ExamListAdapter;
...
public class ExamList extends Fragment implements ServiceInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CommonUtils.setTracking(ExamList.class.getSimpleName());
        ...
        setupToolbar();
        UrlIndex = 1;
        APIAccess.fetchData(ExamList.this, getActivity(), getActivity());
         return rootView;
    }

    private void setId() {
        LinearLayout listexm=(LinearLayout)rootView.findViewById(R.id.listexm);
        listexm.setVisibility(View.GONE);
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                UrlIndex = 1;
                APIAccess.fetchPagingData(ExamList.this, getActivity(), getActivity(), true);
        ...
        pmumdash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment fragment = new ExamListPremium();
    ...
    private void setRecyclerViewAdapter() {
        ...
        adapter = new ExamListAdapter(getActivity(), arrListData);
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                page++;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" +  "&user_id=" + strUserID + "&exam=1");
            } else if (UrlIndex == 1) {
                page = 1;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" +  "&user_id=" + strUserID + "&exam=1");
            }
