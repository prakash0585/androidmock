...
import com.sabakuch.epaper.activity.PaymentCustom;
...
public class Instructioncustom extends Fragment implements ServiceInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CommonUtils.setTracking(Instructioncustom.class.getSimpleName());
        ...
        try
        {
            if(context!=null&&!context.isFinishing())
                if (CommonUtils.isOnline(context)) {
                    ...
                    APIAccess.fetchPagingData(Instructioncustom.this, getActivity(), getActivity(),true);
                }	else {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                   /* Fragment fragment = new OnlineTestPaperSectionFragment();
                    ...
                    Intent intentp=new Intent(context, PaymentCustom.class);
