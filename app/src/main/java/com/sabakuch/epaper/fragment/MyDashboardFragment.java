...
public class MyDashboardFragment extends Fragment implements ServiceInterface {
  ...
  //  private Button pmumdash;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setupToolbar();
      //  APIAccess.fetchData(MyDashboardFragment.this, getActivity(), getActivity());
        return rootView;
    }
...
//            }
    ...
    public String httpPost() {
        ...
        try {
            if (UrlIndex == 0) {
                page++;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" +  "&user_id=" + strUserID + "&examid="+examIddd);
            } else if (UrlIndex == 1) {
                page = 1;
                response = OpenConnection.callUrl(ServiceUrl.SABAKUCH_PAPER_MY_DASHBOARD + "?feed=1" +  "&user_id=" + strUserID + "&examid="+examIddd);
            }
