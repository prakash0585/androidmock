...
public class OnlineTestPaperAdapterPay extends RecyclerView.Adapter<OnlineTestPaperAdapterPay.MyViewHolder> {
    ...
    public OnlineTestPaperAdapterPay(Activity context, List<TestPaperData> data, int sectionPosition) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        CommonUtils.LogMsg(OnlineTestPaperAdapterPay.class.getSimpleName(), "data: " + CommonUtils.getCustomGson().toJson(current));
        ...
        public void setData(final TestPaperData current, final int position) {
            ...
            if (current.Qno != null && !current.Qno.equals("")) {
                if (current.Qno.equals("-1")) {
                    ...
                    if (current.isPassage) {
                        wvQuestion.loadDataWithBaseURL(null, current.passage_text.trim(), "text/html", "utf-8", null);
            ...
            llTestOption1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers1.set(position, "a");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers2.set(position, "a");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers3.set(position, "a");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers4.set(position, "a");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption1.setChecked(true);
                    rgTestOption2.setChecked(false);
                    rgTestOption3.setChecked(false);
            ...
            llTestOption2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers1.set(position, "b");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers2.set(position, "b");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers3.set(position, "b");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers4.set(position, "b");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption2.setChecked(true);
                    rgTestOption1.setChecked(false);
            ...
            llTestOption3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers1.set(position, "c");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers2.set(position, "c");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers3.set(position, "c");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers4.set(position, "c");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption3.setChecked(true);
                    rgTestOption2.setChecked(false);
            ...
            llTestOption4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sectionPosition == 0) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers1.set(position, "d");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId1.set(position, que.qb_id);
                    } else if (sectionPosition == 1) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers2.set(position, "d");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId2.set(position, que.qb_id);
                    } else if (sectionPosition == 2) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers3.set(position, "d");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId3.set(position, que.qb_id);
                    } else if (sectionPosition == 3) {
                        OnlineTestPaperSectionFragmentPay.selectedAnswers4.set(position, "d");
                        OnlineTestPaperSectionFragmentPay.selectedQuestionId4.set(position, que.qb_id);
                    }
                    rgTestOption4.setChecked(true);
                    rgTestOption2.setChecked(false);
